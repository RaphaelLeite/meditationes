...
```
  <div style={styles.meditationBanner}>
    <Feather size={16} style={{ color: '#8b7355', flexShrink: 0, marginTop: 4 }} strokeWidth={1.2} />
    <div>
      ...
      <div style={styles.grid}>
        ...
        <section style={styles.card}>
          <div style={styles.cardHeader}>
            <Sun size={18} strokeWidth={1.3} style={{ color: '#b8894a' }} />
        ...
        <section style={styles.card}>
          <div style={styles.cardHeader}>
            <Moon size={18} strokeWidth={1.3} style={{ color: '#5a6d7c' }} />
        ...
        <section style={{ ...styles.card, gridColumn: '1 / -1' }}>
          <div style={styles.cardHeader}>
            <Flame size={18} strokeWidth={1.3} style={{ color: '#a84432' }} />
        ...
        {trackers.length > 0 && (
          <section style={{ ...styles.card, gridColumn: '1 / -1' }}>
            <div style={styles.cardHeader}>
              <Target size={18} strokeWidth={1.3} style={{ color: '#8b6a3f' }} />
              ...
              {trackers.slice(0, 6).map(t => {
                ...
                return (
                  <div key={t.id} style={styles.miniTracker}>
                    <TIcon size={14} strokeWidth={1.4} style={{ color: '#8b6a3f', flexShrink: 0 }} />
            ...
            return (
              <div key={v.id} style={styles.virtueCard}>
                <div style={styles.virtueCardHead}>
                  <v.icon size={28} strokeWidth={1.2} style={{ color: '#8b6a3f' }} />
                  <div>
      ...
      <div>
        ...
        {trackers.length === 0 && !showForm ? (
          <div style={styles.empty}>
            <Feather size={32} strokeWidth={1} style={{ color: '#c4a582', marginBottom: 12 }} />
    ...
    {view === 'scroll' && (
      <div>
        ...
        {Object.keys(journalHistory).length === 0 ? (
          <div style={styles.empty}>
            <Scroll size={32} strokeWidth={1} style={{ color: '#c4a582', marginBottom: 12 }} />
            ...
            {Object.entries(journalHistory).sort((a, b) => b[0].localeCompare(a[0])).map(([date, entry]) => (
              <div key={date} style={styles.historyCard}>
                <div style={styles.historyDate}>
                  ...
                  {sealedDays[date] && <Lock size={14} strokeWidth={1.5} style={{ marginLeft: '8px', color: '#5a7a3f', verticalAlign: 'middle' }} />}
                </div>
      ...
      <div>
        ...
        <div style={styles.settingsCard}>
          <div style={styles.settingsItem}>
            <Download size={22} strokeWidth={1.3} style={{ color: '#5a7a3f', flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
        ...
        <div style={styles.settingsCard}>
          <div style={styles.settingsItem}>
            <Upload size={22} strokeWidth={1.3} style={{ color: '#8b6a3f', flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
        ...
        <div style={styles.settingsCard}>
          <div style={styles.settingsItem}>
            <X size={22} strokeWidth={1.3} style={{ color: '#a84432', flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
              ...
              <div style={styles.settingsDesc}>
                ...
                {confirmClear && <span style={{ color: '#a84432', fontWeight: 500, display: 'block', marginTop: '6px' }}>Are you sure? Tap again to confirm.</span>}
              </div>
            </div>
            <button onClick={clearAllData}
              style={{ ...styles.settingsBtn, borderColor: '#a84432', color: '#a84432' }}>
            ...
            <div key={k} style={styles.avgBarWrap} title={`${k}: ${val ?? '—'}`}>
              <div style={{ ...styles.avgBar, height: `${h}%`,
                backgroundColor: val === undefined ? 'rgba(139,106,63,0.1)' :
                  (t.direction === 'at_least' ? (val >= t.avgGoal ? '#5a7a3f' : '#c28560') :
                    (val <= t.avgGoal ? '#5a7a3f' : '#c28560'))
              }} />
            </div>
          );
        })}
...
- { box-sizing: border-box; }
  ...
  textarea:focus, input:focus, select:focus { outline: none; border-color: #8b6a3f !important; }
  textarea::placeholder, input::placeholder { color: #b8a27e; font-style: italic; }
  button { cursor: pointer; font-family: inherit; }
  `;

const styles = {
app: { minHeight: ‘100vh’, backgroundColor: ‘#f4ede0’,
backgroundImage: `radial-gradient(ellipse at top left, rgba(200, 170, 120, 0.15), transparent 50%), radial-gradient(ellipse at bottom right, rgba(139, 106, 63, 0.08), transparent 50%), url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='3'/%3E%3CfeColorMatrix values='0 0 0 0 0.5 0 0 0 0 0.4 0 0 0 0 0.3 0 0 0 0.08 0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")`,
color: ‘#2b2418’, fontFamily: “‘EB Garamond’, Georgia, serif”, paddingBottom: ‘80px’ },
loadingScreen: { minHeight: ‘100vh’, backgroundColor: ‘#f4ede0’, display: ‘flex’, alignItems: ‘center’, justifyContent: ‘center’, fontFamily: “‘Cormorant Garamond’, serif” },
loadingText: { fontSize: ‘2rem’, fontStyle: ‘italic’, color: ‘#8b6a3f’, letterSpacing: ‘0.1em’ },
header: { borderBottom: ‘1px solid rgba(139, 106, 63, 0.15)’, backgroundColor: ‘rgba(244, 237, 224, 0.85)’, backdropFilter: ‘blur(8px)’, position: ‘sticky’, top: 0, zIndex: 10 },
...
brandMark: { width: ‘46px’, height: ‘46px’, border: ‘1.5px solid #8b6a3f’, borderRadius: ‘50%’, display: ‘flex’, alignItems: ‘center’, justifyContent: ‘center’, fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘0.95rem’, fontWeight: 500, color: ‘#8b6a3f’, letterSpacing: ‘0.05em’ },
brandTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.75rem’, fontWeight: 500, fontStyle: ‘italic’, lineHeight: 1, color: ‘#2b2418’ },
brandSub: { fontSize: ‘0.8rem’, color: ‘#8b7355’, marginTop: ‘4px’, letterSpacing: ‘0.02em’ },
nav: { display: ‘flex’, gap: ‘4px’, flexWrap: ‘wrap’ },
navBtn: { display: ‘flex’, alignItems: ‘center’, gap: ‘6px’, padding: ‘8px 14px’, border: ‘1px solid transparent’, background: ‘transparent’, color: ‘#6b5b3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, borderRadius: ‘2px’, transition: ‘all 0.2s ease’, letterSpacing: ‘0.03em’ },
navBtnActive: { backgroundColor: ‘rgba(139, 106, 63, 0.1)’, border: ‘1px solid rgba(139, 106, 63, 0.25)’, color: ‘#2b2418’ },
meditationBanner: { maxWidth: ‘1100px’, margin: ‘28px auto 0’, padding: ‘0 24px’, display: ‘flex’, gap: ‘14px’, alignItems: ‘flex-start’ },
meditationText: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.35rem’, fontStyle: ‘italic’, lineHeight: 1.5, color: ‘#3d3220’, fontWeight: 300 },
meditationSource: { fontSize: ‘0.8rem’, color: ‘#8b7355’, marginTop: ‘6px’, letterSpacing: ‘0.05em’ },
...
card: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘24px’, boxShadow: ‘0 1px 2px rgba(60, 40, 20, 0.04)’ },
cardHeader: { display: ‘flex’, alignItems: ‘center’, gap: ‘10px’, marginBottom: ‘20px’, paddingBottom: ‘14px’, borderBottom: ‘1px solid rgba(139, 106, 63, 0.12)’ },
cardTitle: { margin: 0, fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.5rem’, fontWeight: 500, fontStyle: ‘italic’, color: ‘#2b2418’, letterSpacing: ‘0.01em’ },
cardSubtitle: { fontSize: ‘0.8rem’, color: ‘#8b7355’, marginLeft: ‘auto’, letterSpacing: ‘0.04em’, fontStyle: ‘italic’ },
label: { display: ‘block’, fontSize: ‘0.85rem’, color: ‘#6b5b3f’, marginBottom: ‘6px’, marginTop: ‘14px’, letterSpacing: ‘0.02em’, fontStyle: ‘italic’ },
textarea: { width: ‘100%’, padding: ‘10px 12px’, border: ‘1px solid rgba(139, 106, 63, 0.2)’, borderRadius: ‘2px’, backgroundColor: ‘rgba(255, 252, 244, 0.6)’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘1rem’, lineHeight: 1.5, color: ‘#2b2418’, resize: ‘vertical’, transition: ‘border-color 0.2s’ },
textInput: { width: ‘100%’, padding: ‘10px 12px’, border: ‘1px solid rgba(139, 106, 63, 0.2)’, borderRadius: ‘2px’, backgroundColor: ‘rgba(255, 252, 244, 0.6)’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘1rem’, color: ‘#2b2418’ },
virtueRow: { display: ‘grid’, gridTemplateColumns: ‘repeat(auto-fit, minmax(140px, 1fr))’, gap: ‘12px’ },
virtueCheck: { position: ‘relative’, padding: ‘20px 16px’, border: ‘1px solid rgba(139, 106, 63, 0.2)’, borderRadius: ‘2px’, backgroundColor: ‘rgba(255, 252, 244, 0.5)’, color: ‘#8b7355’, display: ‘flex’, flexDirection: ‘column’, alignItems: ‘center’, gap: ‘6px’, transition: ‘all 0.25s ease’ },
virtueCheckActive: { backgroundColor: ‘rgba(168, 68, 50, 0.08)’, borderColor: ‘#a84432’, color: ‘#a84432’ },
...
streakBadge: { position: ‘absolute’, top: ‘8px’, right: ‘8px’, fontSize: ‘0.7rem’, color: ‘#a84432’, fontWeight: 500 },
miniGrid: { display: ‘grid’, gridTemplateColumns: ‘repeat(auto-fit, minmax(200px, 1fr))’, gap: ‘10px’, marginBottom: ‘12px’ },
miniTracker: { display: ‘flex’, alignItems: ‘center’, gap: ‘10px’, padding: ‘10px 12px’, backgroundColor: ‘rgba(255, 252, 244, 0.5)’, border: ‘1px solid rgba(139, 106, 63, 0.12)’, borderRadius: ‘2px’ },
miniName: { fontSize: ‘0.95rem’, color: ‘#2b2418’, overflow: ‘hidden’, textOverflow: ‘ellipsis’, whiteSpace: ‘nowrap’ },
miniStatus: { fontSize: ‘0.78rem’, color: ‘#8b7355’, fontStyle: ‘italic’ },
linkBtn: { background: ‘transparent’, border: ‘none’, color: ‘#8b6a3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.9rem’, fontStyle: ‘italic’, padding: ‘4px 0’ },
sectionHeader: { marginBottom: ‘28px’, borderBottom: ‘1px solid rgba(139, 106, 63, 0.15)’, paddingBottom: ‘16px’ },
sectionTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘2.2rem’, fontWeight: 400, fontStyle: ‘italic’, margin: 0, color: ‘#2b2418’ },
sectionLead: { fontSize: ‘0.95rem’, color: ‘#8b7355’, marginTop: ‘6px’, fontStyle: ‘italic’ },
virtueGrid: { display: ‘grid’, gridTemplateColumns: ‘repeat(auto-fit, minmax(320px, 1fr))’, gap: ‘20px’ },
virtueCard: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘24px’ },
virtueCardHead: { display: ‘flex’, alignItems: ‘center’, gap: ‘14px’, marginBottom: ‘14px’ },
virtueCardName: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.5rem’, fontStyle: ‘italic’, fontWeight: 500, color: ‘#2b2418’, lineHeight: 1 },
virtueCardEng: { fontSize: ‘0.78rem’, color: ‘#8b7355’, letterSpacing: ‘0.08em’, textTransform: ‘uppercase’, marginTop: ‘4px’ },
virtueStat: { marginLeft: ‘auto’, textAlign: ‘right’ },
virtueStatNum: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.75rem’, fontWeight: 500, color: ‘#a84432’, lineHeight: 1 },
virtueStatLabel: { fontSize: ‘0.7rem’, color: ‘#8b7355’, letterSpacing: ‘0.08em’, textTransform: ‘uppercase’ },
virtueDesc: { fontSize: ‘0.95rem’, color: ‘#5a4e37’, fontStyle: ‘italic’, marginBottom: ‘18px’, lineHeight: 1.5 },
dotRow: { display: ‘flex’, gap: ‘4px’, margin: ‘12px 0’ },
dot: { flex: 1, height: ‘20px’, backgroundColor: ‘rgba(139, 106, 63, 0.12)’, borderRadius: ‘1px’ },
dotActive: { backgroundColor: ‘#a84432’ },
virtueFooter: { display: ‘flex’, justifyContent: ‘space-between’, fontSize: ‘0.82rem’, color: ‘#8b7355’, fontStyle: ‘italic’ },
newBtn: { display: ‘flex’, alignItems: ‘center’, gap: ‘8px’, padding: ‘12px 20px’, border: ‘1px solid rgba(139, 106, 63, 0.3)’, backgroundColor: ‘rgba(252, 247, 236, 0.75)’, color: ‘#6b5b3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘1rem’, fontStyle: ‘italic’, borderRadius: ‘2px’, marginBottom: ‘20px’, transition: ‘all 0.2s’ },
formCard: { backgroundColor: ‘rgba(252, 247, 236, 0.9)’, border: ‘1px solid rgba(139, 106, 63, 0.25)’, borderRadius: ‘2px’, padding: ‘24px’, marginBottom: ‘24px’ },
formHeader: { display: ‘flex’, justifyContent: ‘space-between’, alignItems: ‘center’, marginBottom: ‘8px’ },
formTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.4rem’, fontStyle: ‘italic’, margin: 0, color: ‘#2b2418’ },
closeBtn: { background: ‘transparent’, border: ‘none’, color: ‘#8b7355’, padding: ‘4px’ },
typeGrid: { display: ‘grid’, gridTemplateColumns: ‘repeat(auto-fit, minmax(180px, 1fr))’, gap: ‘8px’, marginTop: ‘8px’ },
typeOption: { display: ‘flex’, gap: ‘10px’, alignItems: ‘flex-start’, padding: ‘12px’, border: ‘1px solid rgba(139, 106, 63, 0.2)’, backgroundColor: ‘rgba(255, 252, 244, 0.5)’, color: ‘#6b5b3f’, borderRadius: ‘2px’, textAlign: ‘left’, transition: ‘all 0.2s’ },
typeOptionActive: { backgroundColor: ‘rgba(168, 68, 50, 0.08)’, borderColor: ‘#a84432’, color: ‘#2b2418’ },
typeLabel: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.05rem’, fontStyle: ‘italic’, fontWeight: 500 },
typeDesc: { fontSize: ‘0.78rem’, color: ‘#8b7355’, marginTop: ‘2px’ },
formRow: { display: ‘flex’, gap: ‘10px’, flexWrap: ‘wrap’ },
formActions: { display: ‘flex’, gap: ‘10px’, justifyContent: ‘flex-end’, marginTop: ‘20px’ },
cancelBtn: { padding: ‘10px 18px’, border: ‘1px solid rgba(139, 106, 63, 0.25)’, background: ‘transparent’, color: ‘#6b5b3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, borderRadius: ‘2px’ },
submitBtn: { padding: ‘10px 20px’, border: ‘1px solid #8b6a3f’, backgroundColor: ‘#8b6a3f’, color: ‘#f4ede0’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, borderRadius: ‘2px’ },
empty: { padding: ‘60px 20px’, textAlign: ‘center’, backgroundColor: ‘rgba(252, 247, 236, 0.5)’, border: ‘1px dashed rgba(139, 106, 63, 0.2)’, borderRadius: ‘2px’ },
emptyText: { fontStyle: ‘italic’, color: ‘#8b7355’, fontSize: ‘1.05rem’ },
trackerList: { display: ‘grid’, gridTemplateColumns: ‘repeat(auto-fit, minmax(340px, 1fr))’, gap: ‘16px’ },
trackerCard: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘20px’ },
...
trackerType: { display: ‘flex’, alignItems: ‘center’, gap: ‘5px’, fontSize: ‘0.72rem’, color: ‘#8b6a3f’, letterSpacing: ‘0.08em’, textTransform: ‘uppercase’ },
trackerVirtue: { display: ‘flex’, alignItems: ‘center’, gap: ‘5px’, fontSize: ‘0.72rem’, color: ‘#8b7355’, letterSpacing: ‘0.06em’, textTransform: ‘uppercase’ },
deleteBtn: { background: ‘transparent’, border: ‘none’, color: ‘#b8a27e’, padding: ‘4px’ },
trackerName: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.35rem’, fontStyle: ‘italic’, color: ‘#2b2418’, marginBottom: ‘16px’, lineHeight: 1.3 },
habitRow: { display: ‘flex’, alignItems: ‘center’, gap: ‘14px’, marginBottom: ‘8px’ },
habitToday: { flex: 1, padding: ‘12px’, border: ‘1px solid rgba(139, 106, 63, 0.25)’, backgroundColor: ‘rgba(255, 252, 244, 0.5)’, color: ‘#6b5b3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, fontStyle: ‘italic’, borderRadius: ‘2px’, display: ‘flex’, alignItems: ‘center’, justifyContent: ‘center’, gap: ‘6px’, transition: ‘all 0.25s’ },
habitTodayActive: { backgroundColor: ‘rgba(90, 122, 63, 0.12)’, borderColor: ‘#5a7a3f’, color: ‘#5a7a3f’ },
statBlock: { textAlign: ‘right’, minWidth: ‘70px’ },
statNum: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.6rem’, fontWeight: 500, color: ‘#a84432’, lineHeight: 1 },
statLabel: { fontSize: ‘0.7rem’, color: ‘#8b7355’, letterSpacing: ‘0.06em’, textTransform: ‘uppercase’, marginTop: ‘2px’ },
bigStatRow: { textAlign: ‘center’, padding: ‘14px 0’ },
bigStatNum: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘3rem’, fontWeight: 400, color: ‘#5a7a3f’, lineHeight: 1 },
bigStatLabel: { fontSize: ‘0.8rem’, color: ‘#8b7355’, fontStyle: ‘italic’, marginTop: ‘6px’ },
resetBtn: { width: ‘100%’, padding: ‘10px’, border: ‘1px solid rgba(168, 68, 50, 0.3)’, backgroundColor: ‘transparent’, color: ‘#a84432’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.9rem’, fontStyle: ‘italic’, borderRadius: ‘2px’, marginTop: ‘10px’ },
targetRow: { display: ‘flex’, justifyContent: ‘space-between’, alignItems: ‘flex-start’, gap: ‘12px’, marginBottom: ‘10px’ },
targetCurrent: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.5rem’, color: ‘#2b2418’, fontWeight: 500 },
targetUnit: { fontSize: ‘0.95rem’, color: ‘#8b7355’, fontStyle: ‘italic’, fontWeight: 400 },
targetDeadline: { fontSize: ‘0.78rem’, color: ‘#8b7355’, marginTop: ‘4px’, fontStyle: ‘italic’ },
progressBar: { height: ‘4px’, backgroundColor: ‘rgba(139, 106, 63, 0.15)’, borderRadius: ‘1px’, overflow: ‘hidden’, margin: ‘4px 0 12px’ },
progressFill: { height: ‘100%’, backgroundColor: ‘#a84432’, transition: ‘width 0.4s ease’ },
logRow: { display: ‘flex’, gap: ‘8px’, marginTop: ‘10px’ },
logInput: { flex: 1, padding: ‘8px 10px’, border: ‘1px solid rgba(139, 106, 63, 0.2)’, borderRadius: ‘2px’, backgroundColor: ‘rgba(255, 252, 244, 0.6)’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, color: ‘#2b2418’ },
logBtn: { padding: ‘8px 16px’, border: ‘1px solid #8b6a3f’, backgroundColor: ‘#8b6a3f’, color: ‘#f4ede0’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.9rem’, borderRadius: ‘2px’ },
avgBars: { display: ‘flex’, gap: ‘3px’, height: ‘50px’, alignItems: ‘flex-end’, margin: ‘8px 0 12px’, padding: ‘4px’, backgroundColor: ‘rgba(139, 106, 63, 0.04)’, borderRadius: ‘2px’ },
...
progBtn: { padding: ‘6px 12px’, border: ‘1px solid rgba(139, 106, 63, 0.25)’, background: ‘transparent’, color: ‘#6b5b3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.85rem’, borderRadius: ‘2px’ },
completeBadge: { marginLeft: ‘auto’, display: ‘flex’, alignItems: ‘center’, gap: ‘4px’, color: ‘#5a7a3f’, fontStyle: ‘italic’, fontSize: ‘0.9rem’ },
historyList: { display: ‘grid’, gap: ‘18px’ },
historyCard: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘22px’ },
historyDate: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.25rem’, fontStyle: ‘italic’, color: ‘#2b2418’, paddingBottom: ‘10px’, marginBottom: ‘12px’, borderBottom: ‘1px solid rgba(139, 106, 63, 0.12)’ },
historyBlock: { marginBottom: ‘12px’ },
historyLabel: { display: ‘flex’, alignItems: ‘center’, gap: ‘6px’, fontSize: ‘0.75rem’, color: ‘#8b6a3f’, letterSpacing: ‘0.08em’, textTransform: ‘uppercase’, marginBottom: ‘6px’ },
historyText: { fontSize: ‘0.98rem’, color: ‘#3d3220’, marginBottom: ‘4px’, lineHeight: 1.5 },
footer: { maxWidth: ‘1100px’, margin: ‘40px auto 0’, padding: ‘0 24px’, textAlign: ‘center’ },
footerText: { fontFamily: “‘Cormorant Garamond’, serif”, fontStyle: ‘italic’, fontSize: ‘0.95rem’, color: ‘#8b7355’, letterSpacing: ‘0.08em’ },
settingsCard: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘20px’, marginBottom: ‘14px’ },
settingsItem: { display: ‘flex’, gap: ‘16px’, alignItems: ‘flex-start’ },
settingsTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.25rem’, fontStyle: ‘italic’, fontWeight: 500, color: ‘#2b2418’, marginBottom: ‘4px’ },
settingsDesc: { fontSize: ‘0.9rem’, color: ‘#6b5b3f’, lineHeight: 1.5 },
settingsBtn: { position: ‘relative’, flexShrink: 0, padding: ‘10px 20px’, border: ‘1px solid #8b6a3f’, backgroundColor: ‘transparent’, color: ‘#8b6a3f’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, borderRadius: ‘2px’, cursor: ‘pointer’, alignSelf: ‘flex-start’, marginTop: ‘2px’ },
settingsHelp: { backgroundColor: ‘rgba(252, 247, 236, 0.75)’, border: ‘1px solid rgba(139, 106, 63, 0.15)’, borderRadius: ‘2px’, padding: ‘24px’, marginTop: ‘28px’ },
settingsHelpTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.3rem’, fontStyle: ‘italic’, fontWeight: 500, color: ‘#2b2418’, marginBottom: ‘16px’ },
settingsHelpStep: { display: ‘flex’, gap: ‘12px’, alignItems: ‘flex-start’, fontSize: ‘0.95rem’, color: ‘#3d3220’, lineHeight: 1.5, marginBottom: ‘12px’ },
stepNum: { flexShrink: 0, width: ‘26px’, height: ‘26px’, borderRadius: ‘50%’, border: ‘1px solid #8b6a3f’, display: ‘flex’, alignItems: ‘center’, justifyContent: ‘center’, fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘0.9rem’, color: ‘#8b6a3f’, fontWeight: 500 },
sealedBanner: { display: ‘flex’, gap: ‘14px’, alignItems: ‘center’, padding: ‘18px 20px’, backgroundColor: ‘rgba(90, 122, 63, 0.08)’, border: ‘1px solid rgba(90, 122, 63, 0.25)’, borderRadius: ‘2px’, color: ‘#5a7a3f’ },
sealedTitle: { fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.2rem’, fontStyle: ‘italic’, fontWeight: 500, color: ‘#3d5a2a’ },
sealedSub: { fontSize: ‘0.85rem’, color: ‘#5a7a3f’, marginTop: ‘2px’, fontStyle: ‘italic’ },
sealedField: { backgroundColor: ‘rgba(90, 122, 63, 0.04)’, borderColor: ‘rgba(90, 122, 63, 0.15)’, color: ‘#3d3220’, cursor: ‘default’ },
sealSection: { textAlign: ‘center’, padding: ‘8px 0’ },
sealBtn: { display: ‘inline-flex’, alignItems: ‘center’, gap: ‘8px’, padding: ‘14px 28px’, border: ‘1px solid rgba(139, 106, 63, 0.3)’, backgroundColor: ‘transparent’, color: ‘#6b5b3f’, fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.15rem’, fontStyle: ‘italic’, borderRadius: ‘2px’, transition: ‘all 0.25s’ },
sealBtnConfirm: { display: ‘inline-flex’, alignItems: ‘center’, gap: ‘8px’, padding: ‘14px 28px’, border: ‘1px solid #a84432’, backgroundColor: ‘rgba(168, 68, 50, 0.08)’, color: ‘#a84432’, fontFamily: “‘Cormorant Garamond’, serif”, fontSize: ‘1.05rem’, fontStyle: ‘italic’, borderRadius: ‘2px’, transition: ‘all 0.25s’ },
sealCancel: { display: ‘inline-block’, marginLeft: ‘12px’, padding: ‘14px 20px’, border: ‘none’, backgroundColor: ‘transparent’, color: ‘#8b7355’, fontFamily: “‘EB Garamond’, serif”, fontSize: ‘0.95rem’, fontStyle: ‘italic’ }
};