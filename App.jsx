...
import { Sun, Moon, Scroll, Target, Feather, Check, Plus, X, Flame, Scale, Shield, Leaf, TrendingUp, Calendar, AlertCircle, Download, Upload, Settings } from 'lucide-react';
        ...
        {view === 'today' && (
          <div style={styles.grid}>
            <section style={styles.card}>
              ...
              <textarea style={styles.textarea} value={morningEntry.intention}
                onChange={e => setMorningEntry({ ...morningEntry, intention: e.target.value })}
                onBlur={saveMorning} placeholder="One clear intention..." rows={2} />
              <label style={styles.label}>An obstacle I may face:</label>
              <textarea style={styles.textarea} value={morningEntry.obstacle}
                onChange={e => setMorningEntry({ ...morningEntry, obstacle: e.target.value })}
                onBlur={saveMorning} placeholder="What may test me today?" rows={2} />
              <label style={styles.label}>For this I am grateful:</label>
              <textarea style={styles.textarea} value={morningEntry.gratitude}
                onChange={e => setMorningEntry({ ...morningEntry, gratitude: e.target.value })}
                onBlur={saveMorning} placeholder="A quiet thing..." rows={2} />
            </section>
            ...
            <section style={styles.card}>
              ...
              <textarea style={styles.textarea} value={eveningEntry.didWell}
                onChange={e => setEveningEntry({ ...eveningEntry, didWell: e.target.value })}
                onBlur={saveEvening} rows={2} />
              <label style={styles.label}>Where did I fall short?</label>
              <textarea style={styles.textarea} value={eveningEntry.didPoorly}
                onChange={e => setEveningEntry({ ...eveningEntry, didPoorly: e.target.value })}
                onBlur={saveEvening} rows={2} />
              <label style={styles.label}>Tomorrow, I will:</label>
              <textarea style={styles.textarea} value={eveningEntry.toImprove}
                onChange={e => setEveningEntry({ ...eveningEntry, toImprove: e.target.value })}
                onBlur={saveEvening} rows={2} />
            </section>
            ...
            <section style={{ ...styles.card, gridColumn: '1 / -1' }}>
              ...
              <div style={styles.virtueRow}>
                {VIRTUES.map(v => {
                  ...
                  return (
                    <button key={v.id} onClick={() => toggleVirtue(v.id)}
                      style={{ ...styles.virtueCheck, ...(active ? styles.virtueCheckActive : {}) }}>
